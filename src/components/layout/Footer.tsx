...
const Footer = () => {
  return (
    <footer className="pt-16 pb-8 px-6 md:px-12 border-t border-black/5 bg-black/[0.02]">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-12">
          <div>
            ...
            <p className="mt-4 text-sm text-black/60 leading-relaxed">
              Expand your knowledge and skills with our expertly crafted courses designed for the modern learner.
            </p>
          </div>
        ...
        <div className="pt-8 border-t border-black/5 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-black/60">
            © {new Date().getFullYear()} KnowledgeSpace. All rights reserved.
          </p>
